 ...
 */
contract BerryDao is IBerryDao, EpochUtils, ReentrancyGuard, Utils5, DaoOperator {
    ...
    struct Campaign {
        ...
        uint256 totalFIBSupply; // total FIB supply at the time campaign was created
    ...
    IBerryStaking public immutable staking;
    ...
    constructor(
        ...
        require(_fib != IERC20(0), "ctor: fib token 0");
    ...
    function submitNewCampaign(
        ...
        campaignData[campaignID] = Campaign({
            ...
            totalFIBSupply: fibToken.totalSupply(),
            link: link,
     ...
     *    conclude network fee campaign if needed and caching latest result in BerryDao
     */
     ...
     *      conclude brr campaign if needed and caching latest result in BerryDao
     */
        ...
        )
    {
        ...
        totalFIBSupply = campaign.totalFIBSupply;
        ...
        returns (uint256 optionID, uint256 value)
    {
        ...
        uint256 totalSupply = campaign.totalFIBSupply;
        // something is wrong here, total FIB supply shouldn't be 0
        if (totalSupply == 0) {
            return (0, 0);
        }
        ...
        uint256 votedPercentage = totalVotes.mul(PRECISION).div(campaign.totalFIBSupply);
     ...
     *       return 0 if staker has no votes or stakes
     *       called by 2 functions in BerryDao
     */
