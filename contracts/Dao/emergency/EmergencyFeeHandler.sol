 ...
 */
contract EmergencyBerryFeeHandler is IBerryFeeHandler, PermissionGroupsNoModifiers, ReentrancyGuard, Utils5 {
    ...
    /// @dev claimReserveRebate is implemented for IBerryFeeHandler
    function claimReserveRebate(address) external override returns (uint256) {
        revert("not implemented");
    }

    /// @dev claimStakerReward is implemented for IBerryFeeHandler
    ...
    function setNetworkContract(address _BerryNetwork) external {
        onlyAdmin();
