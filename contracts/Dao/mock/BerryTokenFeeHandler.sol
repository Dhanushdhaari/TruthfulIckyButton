...
/**
 * @title berryTokenFeeHandler
 *
 * @dev berryTokenFeeHandler works tightly with contracts berryNetwork and berryDao.
 ...
 */
contract BerryTokenFeeHandler is IBerryFeeHandler, Utils5, DaoOperator, ReentrancyGuard {
    ...
    /// @dev amount of Twei to burn for each burn fib call
    ...
    /// @dev set fib sanity rate contract and amount twei to burn
    ...
    function burnFib() external onlyNonContract returns (uint256 fibBurnAmount) {
        ...
        // Get rate
        uint256 berryTokenFibRate = berryProxy.getExpectedRateAfterFee(
            quoteToken,
            fib,
            srcAmount,
            0,
        ...
        validateTokenToFibRateToBurn(berryTokenFibRate);

        // Buy some fib and burn
        fibBurnAmount = berryProxy.swapTokenToToken(
            quoteToken,
            srcAmount,
            fib,
            berryTokenFibRate
        ...
        emit FibBurned(fibBurnAmount, quoteToken, srcAmount);
    ...
    function validateTokenToFibRateToBurn(uint256 rateTokenToFib) internal view {
