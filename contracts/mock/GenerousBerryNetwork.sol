...
/*
 * @title Berry Network main contract, takes some fee and reports actual dest amount minus Fees.
 */
contract GenerousBerryNetwork is BerryNetwork {
    ...
    function removeBerryProxy(address networkProxy) external override {
