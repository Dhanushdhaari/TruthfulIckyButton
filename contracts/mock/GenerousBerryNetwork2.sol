...
/*
 * @title GenerousBerryNetwork2 transfer the fixed dest amount to destAddress and returns this amount to proxy
 * This would allow us to check the condition of maxDestAmount
 */
contract GenerousBerryNetwork2 is BerryNetwork {
