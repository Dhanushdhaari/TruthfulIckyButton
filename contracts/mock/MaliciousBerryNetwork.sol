...
/*
 * @title Malicious Berry Network, takes (steals) some extra fees and reports actual dest amount minus Fees.
 */
contract MaliciousBerryNetwork is BerryNetwork {
    ...
    /// @dev Trade API for berryNetwork
