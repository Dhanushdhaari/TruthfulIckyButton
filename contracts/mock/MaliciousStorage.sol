...
contract MaliciousStorage {
    ...
    function setContracts(IBerryFeeHandler _feeHandler, address _matchingEngine)
        external
        pure
    {
        _feeHandler;
    ...
    function addBerryProxy(address networkProxy, uint256 max_approved_proxies)
        external
        pure
    {
        networkProxy;
    ...
    function removeBerryProxy(address networkProxy) external pure {
        networkProxy;
    }
    ...
    function getReservesData(bytes32[] calldata reserveIds, IERC20 , IERC20 )
        ...
        returns (
            ...
            IBerryReserve[] memory reserveAddresses
            )
    {
        isValid = true;
        reserveIds;
        ...
        reserveAddresses = new IBerryReserve[](reserveAddressesLength);
    }
}